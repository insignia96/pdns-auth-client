...
class RingStatisticItem(BaseModel):
    ...
    size: Optional[StrictInt] = Field(default=None, description="Ring size")
    type: Optional[StrictStr] = Field(default=None, description="Set to \"RingStatisticItem\"")
    value: Optional[List[SimpleStatisticItem]] = Field(default=None, description="Named values")
    __properties: ClassVar[List[str]] = ["name", "size", "type", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "type": obj.get("type"),
            "value": [SimpleStatisticItem.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
