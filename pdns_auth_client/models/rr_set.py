...
class RRSet(BaseModel):
    ...
    """ # noqa: E501
    changetype: Optional[StrictStr] = Field(default=None, description="MUST be added when updating the RRSet. Must be REPLACE or DELETE. With DELETE, all existing RRs matching name and type will be deleted, including all comments. With REPLACE: when records is present, all existing RRs matching name and type will be deleted, and then new records given in records will be created. If no records are left, any existing comments will be deleted as well. When comments is present, all existing comments for the RRs matching name and type will be deleted, and then new comments given in comments will be created.")
    ...
    ttl: Optional[StrictInt] = Field(default=None, description="DNS TTL of the records, in seconds. MUST NOT be included when changetype is set to “DELETE”.")
    type: StrictStr = Field(description="Type of this record (e.g. “A”, “PTR”, “MX”)")
    __properties: ClassVar[List[str]] = ["changetype", "comments", "name", "records", "ttl", "type"]
