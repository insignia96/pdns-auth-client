...
class Cryptokey(BaseModel):
    ...
    cds: Optional[List[StrictStr]] = Field(default=None, description="An array of DS records for this key, filtered by CDS publication settings")
    ...
    id: Optional[StrictInt] = Field(default=None, description="The internal identifier, read only")
    ...
    published: Optional[StrictBool] = Field(default=None, description="Whether or not the DNSKEY record is published in the zone")
    type: Optional[StrictStr] = Field(default=None, description="set to \"Cryptokey\"")
    __properties: ClassVar[List[str]] = ["active", "algorithm", "bits", "cds", "dnskey", "ds", "id", "keytype", "privatekey", "published", "type"]
