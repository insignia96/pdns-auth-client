...
class SearchApi:
    ...
    def search_data(
        ...
        q: Annotated[StrictStr, Field(description="The string to search for")],
        max: Annotated[StrictInt, Field(description="Maximum number of entries to return")],
        object_type: Annotated[Optional[StrictStr], Field(description="Type of data to search for, one of “all”, “zone”, “record”, “comment”")] = None,
        ...
        :type max: int
        :param object_type: Type of data to search for, one of “all”, “zone”, “record”, “comment”
    ...
    def _search_data_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/servers/{server_id}/search-data',
